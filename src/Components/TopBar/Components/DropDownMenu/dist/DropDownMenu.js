        ...
        React.createElement(InnerWarpper, null,
            ...
            'Home'.toLowerCase().includes(inputText.toLowerCase()) && React.createElement("a", { href: "MainPage" },
                React.createElement(MenuItem, null,
                    ...
                    "Home")),
            'Publication'.toLowerCase().includes(inputText.toLowerCase()) && React.createElement("a", { href: "Publications" },
                React.createElement(MenuItem, null,
                    React.createElement("img", { src: './icons/publications.png' }),
                    "Publication")),
            'People'.toLowerCase().includes(inputText.toLowerCase()) && React.createElement("a", { href: "TestSite" },
                React.createElement(MenuItem, null,
                    React.createElement("img", { src: './icons/people.png' }),
                    " People")),
            'Entities'.toLowerCase().includes(inputText.toLowerCase()) && React.createElement("a", { href: "Entities" },
                React.createElement(MenuItem, null,
                    React.createElement("img", { src: './icons/entities2.png' }),
                    "Entities")),
            'Administration'.toLowerCase().includes(inputText.toLowerCase()) && React.createElement("a", { href: "TestSite" },
                React.createElement(MenuItem, null,
                    React.createElement("img", { src: './icons/administration.png' }),
                    "Administration")),
            React.createElement(TitleMenuItem, null,
                React.createElement("p", null, "Workspaces")),
            'Client contract'.toLowerCase().includes(inputText.toLowerCase()) && React.createElement("a", { href: "TestSite" },
                React.createElement(MenuItem, null,
                    React.createElement("img", { src: './icons/entities2.png' }),
                    "Client contract")),
            'Supplier contract'.toLowerCase().includes(inputText.toLowerCase()) && React.createElement("a", { href: "TestSite" },
                React.createElement(MenuItem, null,
                    React.createElement("img", { src: './icons/entities2.png' }),
                    "Supplier contract")),
            'Corporate'.toLowerCase().includes(inputText.toLowerCase()) && React.createElement("a", { href: "TestSite" },
                React.createElement(MenuItem, null,
                    React.createElement("img", { src: './icons/entities.png' }),
                    "Corporate")),
            'Group norms'.toLowerCase().includes(inputText.toLowerCase()) && React.createElement("a", { href: "TestSite" },
                " ",
                React.createElement(MenuItem, null,
                    React.createElement("img", { src: './icons/people.png' }),
                    "Group norms ")),
            'Real estate contracts'.toLowerCase().includes(inputText.toLowerCase()) && React.createElement("a", { href: "TestSite" },
                React.createElement(MenuItem, null,
                    React.createElement("img", { src: './icons/entities.png' }),
